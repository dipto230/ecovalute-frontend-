...
<div className="relative flex h-16 shrink-0 items-center border-b border-slate-100 px-5">
  ...
  >
    {/* EcoValuate Logo */}
    <div className="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-white transition-all duration-300 group-hover:scale-105">
      <Image
        src="/logo.png"
                          alt="EcoValuate"
                          width={40}
