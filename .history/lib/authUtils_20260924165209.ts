...
export const doctorProtectedRoutes : RouteConfig = {
    pattern: [/^\/vendor\/dashboard/ ], // Matches any path that starts with /doctor/dashboard
    exact : []
}
...
export const getRouteOwner = (pathname : string) : "SUPER_ADMIN" | "ADMIN" | "VENDOR" | "PATIENT" | "COMMON" | null => {
